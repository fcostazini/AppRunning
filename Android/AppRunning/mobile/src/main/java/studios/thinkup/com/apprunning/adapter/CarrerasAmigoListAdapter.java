 ...
 */
public class CarrerasAmigoListAdapter extends BaseAdapter {
    private List<CarreraAmigoDTO> carreras;
    private Context context;
    private LayoutInflater inflater;
    private SimpleDateFormat sf;

    public CarrerasAmigoListAdapter(Activity context, List<CarreraAmigoDTO> carreras) {
    ...
    public long getItemId(int i) {
        return this.carreras.get(i).getNombreCarrera().hashCode();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CarreraAmigoDTO p = (CarreraAmigoDTO) getItem(position);

        if (p != null) {

            if (p.getNombreCarrera() != null) {
                viewHolder.nombre.setText(p.getNombreCarrera());
            }
            ...
            if (p.getLogoCarrera() != null) {
                Picasso.with(context).load(p.getLogoCarrera())
