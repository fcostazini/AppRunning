...
public class DummyCarreraProvider {
    ...
    private CarreraCabecera[] carreras ={new CarreraCabecera(" Carrera 0", new Date(1438892429646l), "20", "58SU  RK1BE 91C 8FKT HO VREJKAZH21OH64OP", "http://www.mactrast.com/wp-content/uploads/2011/11/Apple-Rainbow-Logo.png"),
            new CarreraCabecera("Carrera 1", new Date(1434226829646l), "40", "82J0EEWUUR5TGV35J20Z1 ALG BFLA8QLHNCF43X063LMCU4RCVY9IFFFZ18ECDROCUIPUX EPYWXF18", "https://ideasinspiringinnovation.files.wordpress.com/2010/01/logo_samsonite_us-1.gif?w=140&h=140", EstadoCarrera.CORRIDA),
            ...
            new CarreraCabecera("Carrera 4", new Date(1431289229646l), "25", "ZJ  450 X 6VT1YDRWP XDQJNT6EZ0ZAMKL2RTFW9K GA38WJEQNB18QWVV6", "https://ideasinspiringinnovation.files.wordpress.com/2010/01/logo_samsonite_us-1.gif?w=140&h=140", EstadoCarrera.CORRIDA),
            ...
            new CarreraCabecera("Carrera 6", new Date(1436905229646l), "35", "MLJQ3HRM27SHPQ1L 9WU281 UF5F2P8I5E RFKDRKVZDVV9HKBK6C7XVRQW D2NIA2SMCXP3L6H94X79RO1V2YBWGO OLG I0RCYCDX7KUMC2G0ZPVS 96F4", "http://goodlogo.com/images/logos/small/bacardi_logo_2471.gif", EstadoCarrera.INSCRIPTO),
            ...
            new CarreraCabecera("Carrera 11", new Date(1434745229646l), "45", "4YFZHJ0XV4UHT5HPIQB14Y040VDGXHHFASGN FYW8 4STFDC6ZBW W344PIG", "https://ideasinspiringinnovation.files.wordpress.com/2010/01/logo_samsonite_us-1.gif?w=140&h=140" , EstadoCarrera.INSCRIPTO),
            ...
            new CarreraCabecera("Carrera 14", new Date(1434313229646l), "10", "FRICVA89VRO48JZTY6OU2K3RD5 EMW7ERM59TIEK", "http://www.mactrast.com/wp-content/uploads/2011/11/Apple-Rainbow-Logo.png" , EstadoCarrera.CORRIDA),
            ...
            new CarreraCabecera("Carrera 18", new Date(1436386829646l), "45", "3RGOEQ2PNPP10 G2LL3V5TUHZU0 OVY9JAN4UGSLDZJ  NKJ8NOVVBPOYEA ETJ VNMFES IMLUZ  497S6KLFV9KFT9ROVMG7KL", "https://ideasinspiringinnovation.files.wordpress.com/2010/01/logo_samsonite_us-1.gif?w=140&h=140" , EstadoCarrera.ME_GUSTA),
            ...
            new CarreraCabecera("Carrera 20", new Date(1431807629646l), "25", "YG3UR8I  7AOMVVM2WF73OD 3AVH46D 3TYQ98NO5Q280T3KPLMGNFNW854R", "http://news.pg.com/sites/pg.newshq.businesswire.com/files/imagecache/logo_listview_thumb/logo/image/PG_logo_dark_blue-thumb.png" , EstadoCarrera.CORRIDA),
            ...
            new CarreraCabecera("Carrera 27", new Date(1434140429646l), "10", "7I 6V4BGH0D0KU30 KR1BCXWO83AD3 6DSA2OO1U3 FKEG2B2ACRHI3J5G5JJHP TDXQWX7YZQHLSE7V", "http://goodlogo.com/images/logos/small/bacardi_logo_2471.gif", EstadoCarrera.INSCRIPTO),
            ...
            new CarreraCabecera("Carrera 29", new Date(1436818829646l), "10", "KJAHSIUY SAID IASUYDIU ASHDIAHSKJDHASK  ASD IASYDIOAYSD IUASDUYAIUSYD IUAYSD ", "https://ideasinspiringinnovation.files.wordpress.com/2010/01/logo_samsonite_us-1.gif?w=140&h=140")
    };
